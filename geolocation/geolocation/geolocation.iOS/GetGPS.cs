    ...
    public class GetGPS : IGetGPS
    {
        ...
        void IGetGPS.GetGPS()
        {
            ...
            if (data == false)
            {
                ...
                {
                    UIApplication.SharedApplication.OpenUrl(new NSUrl("app-settings:root=Privacy&&path=LOCATION_SERVICES"));
                }
                else
                {
                    UIApplication.SharedApplication.OpenUrl(new NSUrl("app-setting:root=Privacy&&path=LOCATION_SERVICES"));
                }
                //var url = new NSUrl("App-Prefs:root=Privacy&path=LOCATION");
                //UIApplication.SharedApplication.OpenUrl(url);
                //var url = new NSUrl("App-Prefs:root=PRIVACY&path=LOCATION_SERVICES");
